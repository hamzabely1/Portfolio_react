...
function Parte_Principal() {
    return (
        <div >
            ...
            <section className="section_principal flex items-center -mx-3 font-sans px-4 mx-auto w-full lg:max-w-screen-lg sm:max-w-screen-sm md:max-w-screen-md pb-20">
                <div class="px-1 w-full lg:w-4/5">
                    ...
                    <img className='w-100' style={{height:"250px"}} src={img} alt="ima-dev" />
